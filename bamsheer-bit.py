...
load_dotenv()
TOKEN = 'ODIwNzExMjQyMzA5MzA0MzYw.YE5I6A.uKOE8VB5zsL3A9tBri0gZD63aFw'# os.getenv('DISCORD_TOKEN')
...
async def _talk(ctx, input):
    ...
    try:
        ...
        await ctx.send("Sorry! I can not do that right now! :/")
